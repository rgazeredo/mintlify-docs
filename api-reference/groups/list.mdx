...
curl -X GET "https://zapclass.com.br/api/groups/list" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer zc_6FrX2qjM4bHT9pR6cC0sD8wLkG3nE2tZfV5uN1aP"
```

```bash cURL - Listar com atualização forçada
curl -X GET "https://zapclass.com.br/api/groups/list?force=true" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer zc_6FrX2qjM4bHT9pR6cC0sD8wLkG3nE2tZfV5uN1aP"
```

```bash cURL - Listar sem participantes
curl -X GET "https://zapclass.com.br/api/groups/list?noparticipants=true" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer zc_6FrX2qjM4bHT9pR6cC0sD8wLkG3nE2tZfV5uN1aP"
```

```bash cURL - Atualizar e sem participantes
curl -X GET "https://zapclass.com.br/api/groups/list?force=true&noparticipants=true" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer zc_6FrX2qjM4bHT9pR6cC0sD8wLkG3nE2tZfV5uN1aP"
```

```javascript JavaScript - Listar grupos
const response = await fetch("https://zapclass.com.br/api/groups/list", {
  method: "GET",
  headers: {
...
async function listGroups(options = {}) {
  ...
  const url = `https://zapclass.com.br/api/groups/list${
...
async function analyzeGroups() {
  const response = await fetch(
    "https://zapclass.com.br/api/groups/list?force=true",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
async function exportGroupsToCSV() {
  const response = await fetch(
    "https://zapclass.com.br/api/groups/list?force=true&noparticipants=true",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
<?php
$url = 'https://zapclass.com.br/api/groups/list';
$ch = curl_init($url);
...
function analyzeGroups() {
    $url = 'https://zapclass.com.br/api/groups/list?force=true';
    $ch = curl_init($url);
