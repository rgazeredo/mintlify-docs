...
<Info>
  **Dica:** Use o modo anúncio para manter grupos organizados e focados,
  evitando conversas paralelas em canais de comunicação oficial.
</Info>
...
const response = await fetch(
  "https://zapclass.com.br/api/group/updateAnnounce",
  {
    method: "POST",
    headers: {
