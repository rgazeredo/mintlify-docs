...
<ParamField path="inviteCode" type="string" required>
  ...
  Exemplo: `AbCdEfGhIjKlMnOpQrSt` ou `https://chat.whatsapp.com/AbCdEfGhIjKlMnOpQrSt`
</ParamField>

<Info>
  **Nota:** Este endpoint não requer que você seja membro do grupo. As informações são públicas para qualquer pessoa com o link de convite.
</Info>
...
// Uso
const result = await validateGroupInvite("https://chat.whatsapp.com/AbCdEfGhIjKlMnOpQrSt");
if (result.valid) {
