...
curl -X POST https://zapclass.com.br/api/groups/inviteInfo \
...
const response = await fetch("https://zapclass.com.br/api/groups/inviteInfo", {
  method: "POST",
  headers: {
...
<?php
$ch = curl_init('https://zapclass.com.br/api/groups/inviteInfo');
...
class GroupInviteModerator {
    ...
    public function checkInvite($inviteCode) {
        $ch = curl_init($this->baseUrl . '/groups/inviteInfo');
