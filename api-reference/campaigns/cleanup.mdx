...
<Info>
  A limpeza remove apenas mensagens com status "done" (enviadas com sucesso).
  Mensagens pendentes, agendadas ou com erro não são afetadas.
</Info>

<Warning>
  **Importante:** O processo é irreversível e executado de forma assíncrona. Não
  há como recuperar mensagens após a limpeza.
</Warning>
