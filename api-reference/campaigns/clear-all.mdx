...
<Warning>
  **⚠️ ATENÇÃO CRÍTICA:** Esta operação é IRREVERSÍVEL e remove TODAS as mensagens e campanhas da fila, incluindo mensagens pendentes e já enviadas. Use com extremo cuidado e apenas quando absolutamente necessário.
</Warning>
