...
<ParamField path="delayMin" type="integer">
  Delay mínimo entre mensagens em segundos. <br />
  Padrão: `3` <br />
  Exemplo: `10`
</ParamField>

<ParamField path="delayMax" type="integer">
...
<ParamField path="scheduled_for" type="integer">
  ...
  **Formatos:** <br />
  ...
  - Imediato: `0` ou omitir
</ParamField>

<Info>
  **Estrutura de cada mensagem no array:** Cada objeto em `messages` deve conter `to`, `type` e os campos específicos do tipo escolhido (text, file, etc). Consulte a documentação de tipos de mensagem.
</Info>
